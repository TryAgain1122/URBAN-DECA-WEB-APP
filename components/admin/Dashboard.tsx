...
const Dashboard = () => {
  ...
  return (
    ...
    //   <div className="flex flex-row justify-start items-center min-w-[1200px]">
    ...
    //     </div>
    //     <Button
    //       className=" font-semibold py-2 px-5 mt-3 md:mt-0 md:ml-4 rounded-md shadow"
    //       color="secondary"
    //       onClick={submitHandler}
    //       isDisabled={isLoading}
    //     >
    //       {/* {isLoading ? <Spinner color="white" size="sm" /> : "Fetch"} */}
    //       Fetch
    //     </Button>
    //   </div>
    //   <div className="min-w-[1200px]">
    //     <div className="overflow-visible py-2 my-5">
    //       <SalesStats data={data} />
    //     </div>
    //   </div>

    //   {/* Sales History and Top performing  */}
