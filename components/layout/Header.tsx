...
export default function Header() {
  ...
  return (
    ...
    //             )}
    //           </DropdownItem>
    //           <DropdownItem key="bookings" href="/bookings/me">My Bookings</DropdownItem>
    //           <DropdownItem key="analytics" href="/me/update">
    //             Profile
    //           </DropdownItem>
    //           <DropdownItem key="logout" color="danger">
    //             <button onClick={() => signOut({ callbackUrl: "/"})} className="text-medium">
    //               logout
    //             </button>
    //           </DropdownItem>
    //         </DropdownMenu>
